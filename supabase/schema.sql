...
-- Auto-create a profile whenever a user signs up (metadata comes from the app).
...
-- Rich DM inbox for the Chats tab.
...
--   • Start the app, sign up, then go to Profile → "Claim Ownership"
--     to make yourself the clan Owner.
-- ============================================================================
